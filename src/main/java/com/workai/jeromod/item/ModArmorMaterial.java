...
public enum ModArmorMaterial implements IArmorMaterial {
    JEROMIUM("jeromium", 40, new int[] { 3, 6, 8, 3 }, 15, SoundEvents.ARMOR_EQUIP_DIAMOND, 3.5F, 0, () -> {
        return Ingredient.of(ModItems.JEROMIUM.get());
    });
    ...
    public String getName() {
        return Jeromod.MOD_ID + ":" + this.name;
    }
